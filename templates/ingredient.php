...
<h2><a href="<?php echo $pages->get("template=recipes")->url; ?>">All recipes</a> with <em><?php echo $page->title; ?></em></h2>

<ul>
<?php
    foreach($pages->find("template=recipe, ingredients.ingredient=$page") as $recipe) {
